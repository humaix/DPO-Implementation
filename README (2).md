...
The final trained DPO model checkpoint is hosted separately on Kaggle due to GitHub file size limitations.

Checkpoint Dataset:
- DPO_training_Step3000 
https://www.kaggle.com/datasets/humaizahmed/dpo-training-step3000
The dataset contains:
- checkpoint_step_3000.zip
- Final trained GPT-2 Medium DPO model weights
